...
def make_dictionary_from_raw_data_for_visualisation ():
...
#df slices the DataFrame to keep only specific columns, that are here listed as columns_to_keep_in_table_experimental and columns_to_keep_in_table_control
    dict_list_experimental = df[columns_to_keep_in_table_experimental]
    dict_list_control = df[columns_to_keep_in_table_control]
    return dict_list_experimental, dict_list_control

# Display or use the trimmed DataFrame
print(dict_list_experimental)
print(dict_list_control)
